        ...
        <div className={styles.container}>
            ...
            <div className={styles['hero-section']}>
                ...
                <div className={styles['body-text']}>
                    ...
                    revolutionize community engagement and participation within
                    Algorand Nigeria. This platform has been designed to create
                    a vibrant ecosystem where contributors and developers are
                    incentivized and rewarded for their invaluable
                    contributions.
                </div>
            </div>
            {/*Hero-section Ends*/}
